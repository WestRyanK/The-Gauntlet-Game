...
LaserTurret::LaserTurret(ShaderProgram* shader, ParticleEmitter* projectile_emitter) : Weapon("laser_turret", shader, projectile_emitter, 45, 0.25f, true)
{
    ...
    this->projectile_prototype->set_collision_region(new BoundingSphere(vec3(), 5));
}