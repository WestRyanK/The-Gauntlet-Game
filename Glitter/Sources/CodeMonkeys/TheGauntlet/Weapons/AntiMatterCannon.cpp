...
AntiMatterCannon::AntiMatterCannon(ShaderProgram* shader, ParticleEmitter* projectile_emitter) : Weapon("antimatter_cannon", shader, projectile_emitter, 160, 2.5f, false)
{
