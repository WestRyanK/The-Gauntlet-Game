...
LaserCannon::LaserCannon(ShaderProgram* shader, ParticleEmitter* projectile_emitter) : Weapon("laser_cannon", shader, projectile_emitter, 130, 2.5f, false)
{
    ...
    AnimatedTexture* projectile_animation = new AnimatedTexture("Assets/Projectiles/LaserCannon/laser_cannon", "png", 16);
    Billboard* projectile_billboard = new Billboard("billboard_laser_cannon", projectile_animation, 15, 15);
