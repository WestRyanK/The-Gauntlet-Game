...
LaserTurret::LaserTurret(ShaderProgram* shader, ParticleEmitter* projectile_emitter) : AlternatingWeapon("laser_turret", shader, projectile_emitter, 340, 0.25f, true)
{
